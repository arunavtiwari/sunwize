                        ...
                        {menuItem.path ? (
                          ...
                          <>
                            <p
                              ...
                              className="text-dark group-hover:text-primary flex cursor-pointer items-center justify-between py-2 font-bold text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-3 dark:text-white/70 dark:group-hover:text-white"
                            >
                              {menuItem.title}
                              <span className="pl-3">
