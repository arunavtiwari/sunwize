...
const keywords = [
  ...
  "3kw solar panel price lucknow", "5kw solar panel price lucknow", "1kw solar panel price lucknow",
  "solar panel cost lucknow", "solar energy lucknow", "solar for home lucknow",
  "solar for business lucknow", "solar installer lucknow", "solar panel gomti nagar",
  "solar panel hazratganj", "solar panel indira nagar lucknow", "solar panel aliganj",
  "solar panel kanpur road lucknow", "sunwize lucknow", "solar panel up", "solar uttar pradesh",
  "solar panel installation uttar pradesh", "solar panel near me lucknow",
];
...
const SolarPanelPriceLucknowGuide = () => (
  <article>
    ...
    <ul>
      <li><strong>1 kW system</strong>: ₹70,000 gross → ₹40,000 after ₹30,000 subsidy</li>
    ...
    <h2>UP Solar Subsidy in Lucknow</h2>
    <p>
      Under PM Surya Ghar Muft Bijli Yojana, Lucknow residents are eligible for:
    </p>
    <ul>
      <li>₹30,000 for 1kW systems</li>
      <li>₹60,000 for 2kW systems</li>
    ...
    <h2>Payback Period for Solar in Lucknow</h2>
    <p>
      Given the high sunshine and competitive electricity rates in Lucknow:
    </p>
    <ul>
      <li>A 1kW system pays back in approximately 3–4 years</li>
      <li>A 3kW system pays back in approximately 4–5 years</li>
      <li>A 5kW system pays back in approximately 4–6 years</li>
    </ul>
    <p>
      After payback, you enjoy 20+ years of nearly free electricity, saving ₹5–15 lakhs over the system&apos;s 25-year lifetime.
    </p>
...
export default SolarPanelPriceLucknowGuide;
